...
# models
RUN wget -O /workspace/repositories/Fooocus/models/loras/realisticStockPhoto_v20.safetensors https://huggingface.co/lllyasviel/fav_models/resolve/main/fav/realisticStockPhoto_v20.safetensors?download=true

RUN wget -O /workspace/repositories/Fooocus/models/loras/juggernautXL_v8Rundiffusion.safetensors https://huggingface.co/RunDiffusion/Juggernaut-X-v10/resolve/main/Juggernaut-X-RunDiffusion-NSFW.safetensor?download=true

# RUN wget -O /workspace/repositories/Fooocus/models/loras/realisticStockPhoto_v10.safetensors https://huggingface.co/lllyasviel/fav_models/resolve/main/fav/realisticStockPhoto_v10.safetensors?download=true

RUN wget -O /workspace/repositories/Fooocus/models/loras/realvisxl-v40.safetensors https://huggingface.co/SG161222/RealVisXL_V4.0/resolve/main/RealVisXL_V4.0.safetensors?download=true

# loras
RUN wget -O /workspace/repositories/Fooocus/models/loras/SDXL_FILM_PHOTOGRAPHY_STYLE_V1.safetensors https://huggingface.co/mashb1t/fav_models/resolve/main/fav/SDXL_FILM_PHOTOGRAPHY_STYLE_V1.safetensors?download=true
